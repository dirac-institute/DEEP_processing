...
export PROC_LSST_CORES_PER_NODE="10" # ${PROC_LSST_CORES_PER_NODE:-48}
export PROC_LSST_MAX_BLOCKS="5" # ${PROC_LSST_MAX_BLOCKS:-1}
export J=10 # cores per worker for local
env | grep PROC_LSST
...
python $w/bin/coadd_subsets.py $REPO allSky $w/data/warp_subsets --subsets '^14$|^15$|^16$' --workers 3
